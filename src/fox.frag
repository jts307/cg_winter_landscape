...
// This is just our normal mapping shader but with an added step of turning the red part of the fox's texture white and adding the snow effect
void main()							
{		
	...
	if(!use_normal_mapping){
		...
		// changing the red part of the fox skin to white
		if (tex_col.r > .5){
			tex_col.rgb = vec3(1.);
		}
